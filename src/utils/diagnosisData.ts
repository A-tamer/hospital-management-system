// Diagnosis hierarchy data - Based on Pediatric Surgery System
...
export const DIAGNOSIS_CATEGORIES: DiagnosisCategory[] = [
  {
    category: 'Abdominal Wall and Hernia',
    subcategories: [
  ...
  {
    category: 'Hypospadias and Penile Disorders',
    subcategories: [
      'Uncircumcised Boy',
  ...
  },
  {
    ...
    subcategories: [
      'Tongue Tie (Fibrous)',
      'Tongue Tie (Membranous)',
      'Thyroglossal Cyst',
      'Thyroglossal Fistula',
      'Recurrent Thyroglossal Cyst or fistula',
      'Branchial Apparatus remenant',
      'Branchial Cyst (Left)',
      'Branchial Cyst (Right)',
      'Branchial Fistula (Left)',
      'Branchial Fistula (Right)',
      'Cervical Lymphadenitis',
      'Cervical Lymph Node Abcess',
      'Dermoid Cyst',
      'Dermoid Cyst (External Angular)',
      'Dermoid Cyst (Internal Angular)',
      'Dermoid Cyst (Presternal)',
      ...
      'Ranula',
      'Lipoma',
      'Sternomastoid Tumour (Lt)',
      'Sternomastoid Tumour (Rt)',
      'Thyroid Swelling (Benign)',
      'Thyroid Tumour (Follicular Carcinoma)',
      'Thyroid Tumour (Papillary Carcinoma)',
  ...
  },
  {
    ...
    subcategories: [
      ...
      'Cleft Soft Palate',
      'Incomplete cleft secondary Palate',
      'Complete Cleft Right Palate',
      'Complete Cleft Left Palate',
      'Complete Bilateral Cleft Palate',
      'Submucous Cleft Palate',
      'Velo-pharyngeal Incompetence',
      'Alveolar bone Defect',
      'Post-cleft Lip Complication',
      'Post-cleft Palate Complication',
      'Palatal Fistula'
    ]
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      'Congenital Diaphragmatic Hernia (Left: Bochdalek)',
      'Congenital Diaphragmatic Hernia (Morgagni Hernia)',
      'Congenital Diaphragmatic Hernia (Morgagni Larrey Hernia)',
  ...
  },
  {
    ...
    subcategories: [
      ...
      'GERD With Sliding Hiatus Hernia',
  ...
  },
  {
    ...
    subcategories: [
      ...
      'Requesting Gastrostomy Tube Insertion'
    ]
  },
  {
    category: 'Duodenum and Intestine Disorders',
    subcategories: [
      'Neonatal Intestinal Obstruction (suspected Intestinal Atresia)',
      'Neonatal Intestinal Obstruction (suspected HD)',
      'Duodenal Atresia',
  ...
  {
    category: 'Hepato-Biliary, Pancreas and Spleen',
    subcategories: [
      'Gall Bladder Stone/s',
      'Cholecystitis (Acute)',
      'Cholecystitis (Chronic)',
      'Biliary Atresia (Type I)',
      'Biliary Atresia (Type II)',
      'Biliary Atresia (Type III)',
      'Choledochal Cyst (Type I)',
      'Choledochal Cyst (Type II)',
      'Choledochal Cyst (Type III)',
      'Choledochal Cyst (Type V)',
      'Choledochal Cyst (Type VI)',
      'Portal Hypertension',
  ...
  },
  {
    ...
    subcategories: [
      'Undescended Testes (Lt Palpable)',
      'Undescended Testes (Lt Nonpalpable)',
      'Undescended Testes (Rt Nonpalpable)',
      'Undescended Testes (Rt Palpable)',
